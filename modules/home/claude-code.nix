        ...
        (
          let
            ...
            nativePlatforms = {
              ...
              "x86_64-darwin" = {
                suffix = "darwin-x64";
                hash = "sha512-CF21le9b41YwDes7U2F5c1zx1mRXZx1MgRAyly4p3ZQM03CP4d96Wa+jsaEjKM+yEoK6bVvsow5fiQTQaUGGIw==";
              };
              "aarch64-linux" = {
                suffix = "linux-arm64";
          ...
          pkgs.buildNpmPackage (finalAttrs: {
            ...
            npmDepsHash = "sha256-L/P5czRTOv42TW1264o0wT3Sfc99lGjhH6lPcR+6kVs=";
