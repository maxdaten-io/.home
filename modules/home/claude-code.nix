    ...
    let
      ...
      notebooklm = pkgs.python312Packages.buildPythonApplication rec {
        ...
        src = pkgs.fetchPypi {
          pname = "notebooklm_py";
          inherit version;
          hash = "sha256-iXo7FO+QRggPN3lZ3myGPFRMoh8QZFjyEkNlDT2aNXk=";
        };
        ...
        (
          let
            ...
            nativePlatforms = {
              ...
              "x86_64-darwin" = {
                suffix = "darwin-x64";
                hash = "sha512-F5P/1sh3Ts9xncj8h5UT6qF+OZxRRt1pKTaiG8vj2gQ0ZRFO5Att6Z917s6Zyu9T7AKDDzYSlqMh+TWq6CjgzQ==";
              };
              "aarch64-linux" = {
                suffix = "linux-arm64";
          ...
          pkgs.buildNpmPackage (finalAttrs: {
            ...
            npmDepsHash = "sha256-4ez6M83/L9lmjhqLOHeEyQqXjufBYPTDECebY0UZkyQ=";
