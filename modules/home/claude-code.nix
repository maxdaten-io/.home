        ...
        (
          let
            ...
            nativePlatforms = {
              ...
              "x86_64-darwin" = {
                suffix = "darwin-x64";
                hash = "sha512-QpAUV9nqDMz1NsMd4nI6gn2c2khSdTAugVKfPoFQbxX+kVZVxE1kpvvfzRNu3bSGSV+kl712dOjH5zhn5FatlQ==";
              };
              "aarch64-linux" = {
                suffix = "linux-arm64";
          ...
          pkgs.buildNpmPackage (finalAttrs: {
            ...
            npmDepsHash = "sha256-JHyRzJwB89B92Iu8gaQCpd5CYorgMTfrY1RXzI5Om9Y=";
