    ...
    (
      let
        ...
        nativePlatforms = {
          ...
          "x86_64-darwin" = {
            suffix = "darwin-x64";
            hash = "sha512-3u47rDjARgQboJ8HloeSHJrDphw9HbUV5YPWIi0ODM75Deyrh67GuXF/OroyQHiC4WwoqifGOhJu/KVDLPh5lA==";
          };
          "aarch64-linux" = {
            suffix = "linux-arm64";
      ...
      pkgs.buildNpmPackage (finalAttrs: {
        ...
        npmDepsHash = "sha256-LOl7yivfQGV70dEfiKihnCTxI420vgVnJCa58Td5uX8=";
