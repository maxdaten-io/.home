    ...
    (
      let
        ...
        nativePlatforms = {
          ...
          "x86_64-darwin" = {
            suffix = "darwin-x64";
            hash = "sha512-5XqqrdSdMmOD88Jqla6+Y3GKoun7M1pvfTYAYTUFadvv8guqo895INf6MnUFeADOE+U6v015r4gX443xc02uGw==";
          };
          "aarch64-linux" = {
            suffix = "linux-arm64";
      ...
      pkgs.buildNpmPackage (finalAttrs: {
        ...
        npmDepsHash = "sha256-wRdx5xoyJ0SDt5/69nkB2FFwTO5FOoRoxFBIu4M2lP4=";
