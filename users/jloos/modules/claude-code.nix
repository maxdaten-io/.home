    ...
    (
      let
        ...
        nativePlatforms = {
          ...
          "x86_64-darwin" = {
            suffix = "darwin-x64";
            hash = "sha512-FN0THf/l/QD2Ce8hHWlmwewRJ8avCtS6C9vSgAzApbBDnDwedu/ojTBzCUKBTZzyz0BZO9+hoQOE0GkKmVhdLg==";
          };
          "aarch64-linux" = {
            suffix = "linux-arm64";
      ...
      pkgs.buildNpmPackage (finalAttrs: {
        ...
        npmDepsHash = "sha256-N3N20xhr7IIP07FO0thjgGx9b0lp6fIboPawkjRr1Y4=";
